 ...
 * Boarding scales with nearby demand zone ΓÇö high demand = more passengers.
 */
function simulateBoarding(bus) {
  ...
  // Scale boarding by demand: low demand (20) ΓåÆ 2-8, high demand (100) ΓåÆ 8-22
...
function updateBusPosition(bus) {
  ...
  if (progress.t >= 1.0) {
    ...
    // Linear interpolation ΓÇö constant speed between stops
